...
enum enQuizzLevel { Easy = 1, Med = 2, Hard = 3, MixLevel = 4 };   //تعريف مستويات الصعوبة
enum enOperationType { Add = 1, Sub = 2, Mul = 3, Div = 4, MixOp = 5 };   //تعريف العمليات الرياضية 
...
stQuestions GenerateQuestion(enQuizzLevel QuizzLevel, enOperationType OpType)
 {
    ...
    if (QuizzLevel == enQuizzLevel::MixLevel) QuizzLevel = (enQuizzLevel)RandomNumber(1, 3);
...
Question.Number1 = RandomNumber(10, 50);                                                                                                                                                                                                                                                  Question.Number2 = RandomNumber(10, 50);              
 break;
...
void ShowFinalQuizzScreen(stQuizz Quizz)
 {
    ...
    if(Quizz.isPass) cout << "\033[32m"; else cout << "\033[31m";
